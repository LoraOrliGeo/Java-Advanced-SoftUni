...
import java_advanced.polymorphism.word.textTransforms.CutTransform;
import java_advanced.polymorphism.word.textTransforms.PasteTransform;
import java_advanced.polymorphism.word.textTransforms.TextTransform;
import java_advanced.polymorphism.word.textTransforms.ToUpperTransform;
...
public class CommandImpl implements CommandInterface {
    ...
    protected List<Command> initCommands() {
        ...
        // just like adding "uppercase" command, add other two commands:
